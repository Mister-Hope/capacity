  ...
  <div class="circuit-wrap">
    ...
    >
      ...
      <div
        ...
        class="w-full relative bg-slate-950/40 rounded-lg p-2 border border-slate-900 overflow-hidden"
      >
        <svg viewBox="0 0 720 140" class="circuit-svg">
          ...
          <g id="btn-charge" class="clickable group" @click="startCharging">
            <rect
              ...
              stroke="#334155"
              stroke-width="1.2"
              class="group-hover:stroke-amber-400 group-hover:fill-slate-800 transition"
            />
            <text
              x="177"
              y="22"
              ...
              font-family="sans-serif"
              font-weight="bold"
              :fill="state === 'charging' ? '#ef4444' : '#94a3b8'"
            >
              充
            </text>
          </g>
          ...
          <g
            ...
            :style="{ opacity: plateCharge > 0.05 ? 1 : 0.4 }"
          >
            <rect
              x="155"
              y="65"
            ...
            <text
              ...
              font-family="sans-serif"
              font-weight="bold"
              :fill="state === 'discharging' ? '#38bdf8' : '#94a3b8'"
            >
              放
            </text>
          </g>
          ...
          <g v-if="state === 'charging'">
            <g
              v-for="i in 3"
              :key="'ue-c-' + i"
              :transform="`translate(${380 - ((electronOffset + i * 35) % 100)}, 40)`"
            >
          ...
          <g v-if="state === 'discharging'">
            <g
              v-for="i in 3"
              :key="'ue-d-' + i"
              :transform="`translate(${280 + ((electronOffset + i * 35) % 100)}, 40)`"
            >
          ...
          <g v-if="state === 'charging'">
            <g
              v-for="i in 2"
              :key="'le-c-' + i"
              :transform="`translate(${314 + ((electronOffset + i * 30) % 66)}, 120)`"
            >
          ...
          <g v-if="state === 'discharging'">
            <g
              v-for="i in 2"
              :key="'le-d-' + i"
              :transform="`translate(${380 - ((electronOffset + i * 30) % 66)}, 120)`"
            >
              <circle cx="0" cy="0" r="3" fill="#ef4444" />
              <text
                x="0"
        ...
        <div class="flex items-center justify-center gap-4 mt-2">
          ...
          >
          <span class="inline-flex items-center gap-1 text-xs opacity-60"
            ><span class="inline-block w-2.5 h-2.5 rounded-sm" style="background: #3b82f6"></span>
            负电（蓝）</span
          >
        </div>
      </div>
